...
(export 'assistant-get-current-page)
...
(defun assistant-set-current-page (assistant page-num)
  (setf (assistant-current-page assistant) page-num))

(export 'assistant-set-current-page)
...
(defcfun (assistant-remove-action-widget "gtk_assistant_remove_action_widget")
    :void
  (assistant (g-object assistant))
  (widget (g-object widget)))
