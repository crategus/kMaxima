...
;;;       right; if a callback is removed while it is being invoked, the
;;;       closure and its parameters won't be freed until the invocation
;;;       finishes.
...
;;; 
;;; invocation_hint :
;;; 	the invocation hint given as the last argument to g_closure_invoke(). [allow-none]
;;; 
;;; marshal_data :
