...
;;; 
;;; Minimum shift count to be used for user defined flags, to be stored in GParamSpec.flags. The maximum allowed is 30 + G_PARAM_USER_SHIFT.
;;; g_param_spec_ref ()
;;; 
;;; GParamSpec *        g_param_spec_ref                    (GParamSpec *pspec);
;;; 
...
;;; 
;;; Returns :
;;; 	paramspec to which requests on this paramspec should be redirected, or NULL if none. [transfer none]
;;; 
;;; Since 2.4
;;; ----------------------------------------------------------------------------
